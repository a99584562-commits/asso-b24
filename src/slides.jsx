...
const BOX = [
  ...
  { g: Icon.spark, t: "Диск и база знаний", d: "Хранение всех документов — договоры, акты, регламенты, шаблоны: общий доступ, версии, поиск." },
...
const VIBE = [
  ...
  { g: Icon.channels, t: "Авто-выгрузка на ЦИАН/Авито", d: "Из каталога квартир в CRM формируется XML-фид — автозагрузка на ЦИАН, Авито, Яндекс, обновляется сам." },
];
function Showcase() {
  return (
    <Frame>
...
export const SLIDES = [
  ...
  { id: "s2", section: "Внутрянка", el: <SectionMark no="01" label="Внутренние процессы" /> },
  ...
  { id: "s1", section: "Продажи", el: <SectionMark no="02" label="Продажи" /> },
